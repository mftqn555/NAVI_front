    ...
    <div class="">
        <div v-show="comments != ''" class="mt-5 mb-3">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                class="bi bi-chat-fill float-start me-2" viewBox="0 0 16 16">
                <path
        ...
        <div v-if="comments != ''" v-for="comment in comments" :key=comment.cno>
            ...
            <div v-show="comment.re_cno == comment.cno" class="border-0 card mb-3">
                ...
                <div v-show="this.nickname === comment.nickname &&
                    ...
                    <div class="card mt-2 ms-4">
                        <div class="card-body">
                            <textarea v-if="this.updateCno != null && this.isHidden.update === false"
                                v-model="this.updateContent" placeholder="댓글 수정"></textarea>
                            <textarea v-if="this.replyCno != null && this.isHidden.reply === false" v-model="this.comment"
                                placeholder="답글 작성"></textarea>
                        </div>
                    </div>
                    <div class="mt-3 d-grid gap-2 d-md-flex justify-content-md-end">
                        <button v-if="this.updateCno != null && this.isHidden.update === false" @click="updateComment()"
                            class="btn btn-primary me-md-2" type="button">수정</button>
                        <button v-if="this.replyCno != null && this.isHidden.reply === false" @click="addComment()"
                            class="btn btn-primary me-md-2" type="button">등록</button>
            ...
            <div v-show="comment.re_cno != comment.cno" class="card border-0 mb-3 ms-4">
                ...
                <!-- 답글-->
                <!-- 답글 수정창-->
                <div v-show="this.nickname == comment.nickname && isHidden.card == false && this.updateCno == comment.cno">
                    <div class="card mt-2 ms-4">
                        <div class="card-body">
...
export default {
    ...
    methods: {
        ...
        clickUpdate(cno) {
            this.updateCno = cno
            this.isHidden.card = false
            this.isHidden.update = false
            this.isHidden.reply = true
        },
        clickReply(cno) {
            this.replyCno = cno
            this.isHidden.card = false
            this.isHidden.update = true
            this.isHidden.reply = false
        },
        clickCancel() {
            this.updateCno = null;
            this.replyCno = null;
            this.isHidden.card = true;
        },
        clickDelete(cno) {
